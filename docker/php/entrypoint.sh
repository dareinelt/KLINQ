...
# Zeitgesteuerte Jobs (AD-Synchronisation, Help-Desk-SLA/Eskalation) als Hintergrundprozess (nur wenn konfiguriert)
ad_scheduled=0; hd_scheduled=0
...
if [ "$ad_scheduled" = "1" ] || [ "$hd_scheduled" = "1" ]; then
