...
| Help Desk (Agent/Portal/API) | `routes/modules/helpdesk.php` | `Helpdesk\{HelpdeskDashboardController, TicketController, TicketAttachmentController, KnowledgeBaseController, HelpdeskReportController, HelpdeskAdminController, HelpdeskApiController, PortalController, QuickReportController, HelpdeskSupportShiftController}` | `Helpdesk\{TicketService, TicketWorkflowService, TicketSlaService, TicketRuleService, TicketRuleEvaluator, TicketMergeService, TicketNumberService, TicketNotificationService, TicketPriorityMatrix, TicketReportService, TicketMailIngestionService, HelpdeskAdminService, HelpdeskSchedulerService, KnowledgeBaseService, MailboxSettingsService, ReporterIdentityService, SupportShiftService}`, `Helpdesk\Mail\{ImapMailboxClient, FileMailboxClient, MailboxClientFactory, MimeMessageParser}` | `helpdesk/` | [helpdesk](docs/helpdesk.md) |
